...
export const AGENT_REGISTRY: AgentConfig[] = [
  // Phase 0 Agents (pre-processing - run in parallel)
  {
    ...
    options: { model: 'openai/gpt-5.2', maxTokens: 4096 },
  ...
  },
  {
    ...
    options: { model: 'openai/gpt-5.2', maxTokens: 1024 },
  ...
  },
  {
    ...
    options: { model: 'google/gemini-2.5-flash', temperature: 0.4, maxTokens: 2048 },
    isCritical: true,
  ...
  },
  {
    ...
    options: { model: 'openai/gpt-5.2', temperature: 0.2, maxTokens: 8192 },
    isCritical: false,
  ...
  },
  {
    ...
    options: { model: 'openai/gpt-5.2', temperature: 0.1, maxTokens: 4096 },
    isCritical: false,
  ...
  },
  {
    ...
    options: { model: 'openai/gpt-5.2', temperature: 0.3, maxTokens: 2048 },
    isCritical: false,
  ...
  // Phase 2 Agent (runs after phase 1 completes)
  {
    ...
    options: { model: 'google/gemini-3-pro-preview', temperature: 0.3, maxTokens: 8192 }, // Gemini 3 Pro for superior reasoning - increased for reasoning headroom
    isCritical: false,
