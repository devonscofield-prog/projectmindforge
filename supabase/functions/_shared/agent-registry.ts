...
export const AGENT_REGISTRY: AgentConfig[] = [
  ...
  // Phase 1 Agents (run in parallel)
  {
    ...
    options: { model: 'google/gemini-3-pro-preview', maxTokens: 8192 },
    isCritical: true,
  ...
  },
  {
    ...
    options: { model: 'google/gemini-3-pro-preview', temperature: 0.4, maxTokens: 8192 },
    isCritical: true,
  ...
  },
  {
    ...
    options: { model: 'openai/gpt-5.2', temperature: 0.3, maxTokens: 8192 },
    isCritical: false,
