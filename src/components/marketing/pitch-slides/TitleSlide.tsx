  ...
  return (
    <div className="flex flex-col items-center justify-center h-full text-center px-8">
      ...
      <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mb-8">
        Transform every call into a coaching opportunity
      </p>
      
      <div className="flex flex-wrap justify-center gap-4 text-sm text-muted-foreground">
        <span className="px-3 py-1 rounded-full border border-border">AI Call Analysis</span>
        <span className="px-3 py-1 rounded-full border border-border">Real-Time Coaching</span>
        <span className="px-3 py-1 rounded-full border border-border">Performance Insights</span>
      </div>
    </div>
  );
}
