...
// Rating colors available for future use
// const _ratingColors = { excellent: 'bg-emerald-500', good: 'bg-green-500', acceptable: 'bg-yellow-500', warning: 'bg-orange-500', critical: 'bg-destructive' } as const;
